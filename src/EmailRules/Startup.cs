...
namespace EmailRules
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            .AddType<DeleteRuleInputType>()
            .AddType<DeleteRulePayloadType>()
            .AddType<ConditionType>()
            .AddType<AddConditionInputType>()
            .AddType<AddConditionPayloadType>()
            .AddType<DeleteConditionInputType>()
            .AddType<DeleteConditionPayloadType>()
            .AddType<SpecificConditionType>()
            .AddType<ActionType>()
            .AddType<AddActionInputType>()
            .AddType<AddActionPayloadType>()
            .AddType<DeleteActionInputType>()
            .AddType<DeleteActionPayloadType>()
